  ...
  return (
    <div className="pb-20 sm:pb-24 overflow-hidden bg-white dark:bg-black text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <section className="pt-14 sm:pt-20 md:pt-28 text-center px-4">
        <Container>
          <div className="inline-flex items-center justify-center px-4 sm:px-5 py-2 rounded-full border border-violet-200 dark:border-white/10 bg-violet-50 dark:bg-white/5 mb-6 sm:mb-8">
            <span className="text-[10px] font-bold tracking-[0.2em] text-violet-600 dark:text-violet-400 uppercase">Get Involved</span>
          </div>
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-serif text-gray-900 dark:text-white leading-tight">
            Help us build a <br className="hidden sm:block" />
            <span className="italic text-violet-600 dark:text-violet-500 font-light pr-2">better life</span>
          </h1>
          <p className="mt-4 sm:mt-6 text-gray-600 dark:text-gray-400 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
      ...
      <section className="mt-14 sm:mt-20 md:mt-32">
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            {/* 1. Volunteer (Solid Purple Icon with Glow) */}
            ...
            {/* 2. Donate (Dark Icon + Top Glow + Solid Button) */}
            ...
            {/* 3. Internship (Solid Purple Icon with Glow) */}
            <div className="group flex flex-col items-center text-center h-full rounded-[2rem] p-8 transition duration-500 
                            bg-white border border-gray-100 shadow-xl shadow-gray-200/50
                            dark:bg-[#0B0618] dark:border-white/5 dark:shadow-none">
            ...
            {/* 4. Partner (Solid Purple Icon with Glow) */}
            <div className="group flex flex-col items-center text-center h-full rounded-[2rem] p-8 transition duration-500 
                            bg-white border border-gray-100 shadow-xl shadow-gray-200/50
                            dark:bg-[#0B0618] dark:border-white/5 dark:shadow-none">
