...
export default function Join() {
  return (
    <div className="overflow-hidden bg-white dark:bg-black text-gray-900 dark:text-white transition-colors duration-300">

      {/* ===== HERO WITH BACKGROUND IMAGE ===== */}
      <section className="relative pt-32 sm:pt-40 md:pt-48 pb-20 sm:pb-28 text-center px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-bg1 via-transparent to-transparent"></div>
        </div>

        {/* 2. CONTENT */}
        <Container className="relative z-10">
          
          <div className="inline-flex items-center justify-center px-5 py-2 rounded-full border border-white/20 bg-white/10 backdrop-blur-md mb-8 shadow-lg">
            <span className="text-[10px] font-bold tracking-[0.2em] text-white uppercase">Get Involved</span>
          </div>
          
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-serif text-white leading-tight drop-shadow-lg">
            Help us build a <br className="hidden sm:block" />
            <span className="italic text-violet-400 font-light pr-2">better life</span>
          </h1>
          
          <p className="mt-6 text-gray-200 text-sm md:text-base max-w-xl mx-auto leading-relaxed drop-shadow-md font-medium">
      ...
      {/* ===== WAYS TO HELP ===== */}
      {/* UI FIX: Changed 'mt' (margin) to 'py' (padding) so the background color fills the whole area without gaps */}
      <div className="bg-bg1 py-20 sm:py-28 relative z-20">
        <Container>
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-3xl sm:text-4xl md:text-5xl font-serif text-white dark:text-black uppercase">Ways you can help</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="group flex flex-col items-center text-center h-full rounded-[2rem] p-8 transition duration-500 
                          bg-white border border-gray-100 shadow-xl shadow-gray-200/50 hover:-translate-y-2
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed flex-1 mb-8">Share your time and skills with our local teams at our Iyakkachchi center.</p>
            ...
            <div className="group flex flex-col items-center text-center h-full rounded-[2rem] p-8 transition duration-500 relative overflow-hidden
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed flex-1 mb-8 relative z-10">Your gifts fund education, nutrition, and essential resources for children.</p>
            ...
            <div className="group flex flex-col items-center text-center h-full rounded-[2rem] p-8 transition duration-500 
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed flex-1 mb-8">Gain hands-on experience in community development and humanitarian work.</p>
            ...
            <div className="group flex flex-col items-center text-center h-full rounded-[2rem] p-8 transition duration-500 
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed flex-1 mb-8">Join us as an organization. Like Hope4Child Canada, your partnership creates impact.</p>
