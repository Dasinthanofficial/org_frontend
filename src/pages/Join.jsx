    ...
    <div className="pb-20 sm:pb-24 overflow-hidden bg-bg0 text-text transition-colors duration-300">
      ...
      <section className="pt-14 sm:pt-20 md:pt-28 text-center px-4">
        <Container>
          ...
          <div className="inline-flex items-center justify-center px-4 sm:px-5 py-2 rounded-full border border-border bg-primary/10 mb-6 sm:mb-8">
      ...
      <section className="mt-14 sm:mt-20 md:mt-32">
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-5 md:gap-6 max-w-5xl mx-auto">
            {/* Volunteer */}
            {/* FIX 2: hover:border-primary/30 changed to hover:border-primary */}
            <div className="glass bg-panel rounded-[1.5rem] sm:rounded-[2rem] p-5 sm:p-6 md:p-8 flex flex-col items-center text-center hover:border-primary transition duration-500 border border-border">
            ...
            {/* Donate */}
            {/* FIX 3: border-primary/20 changed to border-border, hover:border-primary/40 changed to hover:border-primary */}
            <div className="glass bg-panel rounded-[1.5rem] sm:rounded-[2rem] p-5 sm:p-6 md:p-8 flex flex-col items-center text-center relative overflow-hidden border border-border shadow-[0_0_40px_rgba(139,92,246,0.05)] hover:border-primary transition duration-500">
              <div className="absolute inset-0 bg-gradient-to-b from-primary/5 to-transparent pointer-events-none"></div>
              {/* FIX 4: border-primary/10 changed to border-border */}
              <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-4 sm:mb-5 relative z-10 border border-border">
            ...
            {/* Internship */}
            {/* FIX 5: hover:border-primary/30 changed to hover:border-primary */}
            <div className="glass bg-panel rounded-[1.5rem] sm:rounded-[2rem] p-5 sm:p-6 md:p-8 flex flex-col items-center text-center hover:border-primary transition duration-500 border border-border">
              <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-full bg-bg1 flex items-center justify-center text-primary mb-4 sm:mb-5 border border-border">
            ...
            {/* Partner */}
            {/* FIX 6: hover:border-primary/30 changed to hover:border-primary */}
            <div className="glass bg-panel rounded-[1.5rem] sm:rounded-[2rem] p-5 sm:p-6 md:p-8 flex flex-col items-center text-center hover:border-primary transition duration-500 border border-border">
              <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-full bg-bg1 flex items-center justify-center text-primary mb-4 sm:mb-5 border border-border">
