        ...
        <Container>
          <div className="grid md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 lg:gap-24 items-center">
            ...
            <div className="mt-8 sm:mt-10 md:mt-0">
              <span className="inline-block px-3 sm:px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary text-[10px] font-bold tracking-[0.2em] uppercase mb-5 sm:mb-6">
                Our Journey
              </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              <div key={i} className="glass rounded-[1.2rem] sm:rounded-[1.5rem] p-5 sm:p-6 lg:p-8 hover:bg-bg1 transition duration-300 border border-border">
                <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-[0.6rem] sm:rounded-[0.8rem] bg-primary/10 border border-primary/20 flex items-center justify-center text-primary mb-4 sm:mb-6">
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
            {[
              ...
              <div key={i} className="group relative rounded-[2rem] p-8 text-center bg-panel border border-border hover:border-primary/30 transition-all duration-500 hover:-translate-y-1 hover:shadow-lg flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 max-w-3xl mx-auto">
              {[
                ...
                <div key={i} className="glass rounded-[1.2rem] sm:rounded-[1.5rem] p-5 sm:p-6 text-center border border-border">
                  <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center text-primary text-lg sm:text-xl font-bold mx-auto mb-3 sm:mb-4">
                    {m.name.charAt(m.name.indexOf(".") + 2)}
                  </div>
                  <h4 className="text-sm sm:text-base font-semibold text-text">{m.name}</h4>
                  <span className="inline-block mt-2 px-3 py-1 rounded-full border border-primary/30 bg-primary/10 text-[9px] sm:text-[10px] tracking-[0.15em] font-bold text-primary uppercase">{m.role}</span>
                </div>
              ))}
            </div>
          </div>
